...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const knockout_1 = __importDefault(__webpack_require__(/*! knockout */ "./node_modules/knockout/build/output/knockout-latest.js"));
function Initialization(serviceProvider) {
    return __awaiter(this, void 0, void 0, function* () {
        knockout_1.default.components.register("content", {
            template: "<div>Hallo Welt</div>"
        });
        knockout_1.default.applyBindings({});
        return Promise.resolve();
    });
}
...
const Run_1 = __importDefault(__webpack_require__(/*! ./Run */ "./src/Run.ts"));
