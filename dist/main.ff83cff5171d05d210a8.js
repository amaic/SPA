...
var IStateKey_1 = __webpack_require__(/*! ../interfaces/IStateKey */ "../amaic-sma/dist/interfaces/IStateKey.js");
var StateKey = /*#__PURE__*/function () {
  function StateKey(storageType, key, scope) {
    _classCallCheck(this, StateKey);
    this.IStateKey = IStateKey_1.IStateKeyIdentifier;
    this._storageType = storageType;
    this._key = key;
    this._scope = scope == undefined ? null : scope;
  }
  _createClass(StateKey, [{
    key: "StorageType",
    get: function get() {
    ...
    key: "FullQualifiedName",
    get: function get() {
      return this._scope == null ? this._key : "".concat(this._scope, "-").concat(this._key);
    }
  }]);
  return StateKey;
}();
...
var StorageTypeNotRegistered_1 = __importDefault(__webpack_require__(/*! ../errors/StorageTypeNotRegistered */ "../amaic-sma/dist/errors/StorageTypeNotRegistered.js"));
var IStateManager_1 = __webpack_require__(/*! ../interfaces/IStateManager */ "../amaic-sma/dist/interfaces/IStateManager.js");
var StateManager = /*#__PURE__*/function () {
  function StateManager(storages) {
  ...
  _createClass(StateManager, [{
    key: "_getStorage",
    value: function _getStorage(storageType) {
      var storage = this._storages[storageType];
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                storage = this._getStorage(stateKey.StorageType);
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                storage = this._getStorage(stateKey.StorageType);
                _context2.next = 3;
                return storage.GetState((_b = (_a = stateKey.Scope) === null || _a === void 0 ? void 0 : _a.Scope) !== null && _b !== void 0 ? _b : null, stateKey.Key);
              case 3:
    ...
    key: "GetRegisteredStorageTypes",
    value: function GetRegisteredStorageTypes() {
...
var StorageTypeNotRegistered = /*#__PURE__*/function (_Error) {
  _inherits(StorageTypeNotRegistered, _Error);
  var _super = _createSuper(StorageTypeNotRegistered);
  function StorageTypeNotRegistered() {
    var message = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "Storage type not registered.";
    _classCallCheck(this, StorageTypeNotRegistered);
    return _super.call(this, message);
  }
  return _createClass(StorageTypeNotRegistered);
...
var StateManager_1 = __importDefault(__webpack_require__(/*! ./classes/StateManager */ "../amaic-sma/dist/classes/StateManager.js"));
exports.StateManager = StateManager_1["default"];
var StateManagerLocalStorage_1 = __importStar(__webpack_require__(/*! ./storages/StateManagerLocalStorage */ "../amaic-sma/dist/storages/StateManagerLocalStorage.js"));
...
var IStateManagerStorage_1 = __webpack_require__(/*! ./interfaces/IStateManagerStorage */ "../amaic-sma/dist/interfaces/IStateManagerStorage.js");
...
var StateKey_1 = __importDefault(__webpack_require__(/*! ./classes/StateKey */ "../amaic-sma/dist/classes/StateKey.js"));
...
var StateManagerLocationStorage_1 = __importStar(__webpack_require__(/*! ./storages/StateManagerLocationStorage */ "../amaic-sma/dist/storages/StateManagerLocationStorage.js"));
...
var IStateManagerStorage_1 = __webpack_require__(/*! ../interfaces/IStateManagerStorage */ "../amaic-sma/dist/interfaces/IStateManagerStorage.js");
var StateManagerLocalStorage = /*#__PURE__*/function () {
  function StateManagerLocalStorage() {
    _classCallCheck(this, StateManagerLocalStorage);
    this.IStateManagerStorage = IStateManagerStorage_1.IStateManagerStorageIdentifier;
  }
  _createClass(StateManagerLocalStorage, [{
    key: "StorageType",
    get: function get() {
      return exports.StateManagerLocalStorageType;
    }
  }, {
    key: "_getFullQualifiedKey",
    value: function _getFullQualifiedKey(scope, key) {
      return scope == null ? key : "".concat(scope, ".").concat(key);
    }
  }, {
    key: "SetState",
    value: function SetState(scope, key, value) {
      return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var fullQualifiedKey;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                fullQualifiedKey = this._getFullQualifiedKey(scope, key);
                if (value == null) {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                fullQualifiedKey = this._getFullQualifiedKey(scope, key);
                return _context2.abrupt("return", window.localStorage.getItem(fullQualifiedKey));
              case 2:
              case "end":
                return _context2.stop();
            }
  ...
  return StateManagerLocalStorage;
}();
...
var IStateManagerStorage_1 = __webpack_require__(/*! ../interfaces/IStateManagerStorage */ "../amaic-sma/dist/interfaces/IStateManagerStorage.js");
var StateManagerLocationStorage = /*#__PURE__*/function () {
  function StateManagerLocationStorage() {
    _classCallCheck(this, StateManagerLocationStorage);
    this.IStateManagerStorage = IStateManagerStorage_1.IStateManagerStorageIdentifier;
  }
  _createClass(StateManagerLocationStorage, [{
    key: "StorageType",
    get: function get() {
    ...
    key: "SetState",
    value: function SetState(scope, key, value) {
      var fullQualifiedKey = this._getFullQualifiedKey(scope, key);
    ...
    value: function GetState(scope, key) {
      var fullQualifiedKey = this._getFullQualifiedKey(scope, key);
      var searchParams = new URLSearchParams(window.location.search);
      var value = searchParams.get(fullQualifiedKey);
      return Promise.resolve(value);
    }
  }]);
  return StateManagerLocationStorage;
}();
...
function Initialization(serviceProvider) {
    return __awaiter(this, void 0, void 0, function* () {
        const { default: test } = yield __webpack_require__.e(/*! import() */ "src_modules_index_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./modules/index */ "./src/modules/index.ts"));
        console.debug(test());
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("ff83cff5171d05d210a8")
/******/ 	})();
/******/ 	
...
/* harmony import */ var _ServiceRegistration__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ServiceRegistration */ "./src/ServiceRegistration.ts");



(0,_Bootloader__WEBPACK_IMPORTED_MODULE_0__["default"])({
    appSettingsUrl: "./appSettings.json",
    registerServices: _ServiceRegistration__WEBPACK_IMPORTED_MODULE_2__["default"],
...
/******/ })()
;
//# sourceMappingURL=main.ff83cff5171d05d210a8.js.map